...
describe('vector', function () {
  ...
  describe('#normalize', function () {
    it('ensures all keys in a vector have valid values', function () {
  ...
  describe('#parse', function () {
    it('converts a vector string to an object', function () {
  ...
  describe('#toString', function () {
    it('serializes it\'s `this` to a CVSS3 vector string', function () {
      var parsed = vector.parse(internals.vectorString);
  ...
  describe('#validate', function () {
    ...
    it('returns an error if input string is not a valid CVSS3 vector', function () {
    ...
    it('returns an error if vector is missing required metrics', function () {
    ...
    // Operations
    it('normalizes object inputs', function () {
    ...
    it('parses and normalizes string inputs', function () {
     var oldNormalize = vector.normalize;
     var normalizeCalls = [];
     vector.normalize = function () {
    ...
    it('sets hasTemporal flag to true when temporal metrics are present', function () {
    ...
    it('sets hasEnvironmental flag to true when environmental metrics are present', function () {
    ...
    it('adds toString to vector for re-serialization', function () {
