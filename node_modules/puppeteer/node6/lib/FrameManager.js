...
class Frame {
  ...
  return new Promise((resolve, reject) => {
    ...
    const result = (yield this.evaluate(pageFunction, elementHandle, ...args));
  ...
  return new Promise((resolve, reject) => {
    ...
    const context = (yield this._contextPromise);
    const arrayHandle = (yield context.evaluateHandle(selector => Array.from(document.querySelectorAll(selector)), selector));
    const result = (yield this.evaluate(pageFunction, arrayHandle, ...args));
...
class WaitTask {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (!error && (yield this._frame.evaluate(s => !s, success))) {
      (yield success.dispose());
      return;
    }
